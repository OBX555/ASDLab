...
public class Reaperssytche3lvlvupProcedure {
	public static void execute(Entity entity, ItemStack itemstack) {
		...
		if (itemstack.getOrCreateTag().getDouble("xp") >= itemstack.getOrCreateTag().getDouble("xpn")) {
			...
			itemstack.getOrCreateTag().putDouble("xpn", (1.7 * itemstack.getOrCreateTag().getDouble("xpn")));
		}
		if (entity instanceof LivingEntity _entity)
			...
			}, (float) (1.2 * itemstack.getOrCreateTag().getDouble("lvl")));
